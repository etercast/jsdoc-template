...
function needsSignature(doclet) {
  const kinds = ['function', 'class', 'typedef', 'enum']
...
function buildNav(members) {
  ...
  nav = nav.concat(buildMemberNav(members.enums, "Enums", seen, linkto))
  ...
  nav = nav.concat(buildMemberNav(members.typedefs, "Types", seen, linkto))
